  ...
  return <div className="w-2/3">
      <div className="relative">
       ...
       <div className="px-3">
          ...
          {
            props.skills.map((skill:any,index:any) => <div key={index} className="bg-bright-sun-950 text-sm font-medium bg-opacity-15 rounded-3xl text-bright-sun-400 px-3 py-1">{skill}</div>)
          }
          </div>
          ...
          <Divider mx="xs" my="xl" />
          <div className="px-3 ">
            <div className="text-2xl font-semibold mb-5">Experiences</div> 
