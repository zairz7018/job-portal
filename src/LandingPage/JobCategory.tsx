...
const JobCategory = () => {
  return <div className="mt-20 pb-5">
        ...
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Explore diverse opportinuties tailored to your skills . start your carrer journey today ! </div>
