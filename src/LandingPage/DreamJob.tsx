    ...
    <div className="flex sm-mx:flex-col-reverse items-center px-16 bs-mx:px-10 md-mx:px-5">
      ...
      <div className="w-[55%] flex items-center justify-center sm-mx:w-full">
          <div  className="w-[30rem] relative">
            ...
            <div className='absolute -right-10 w-fit xs-mx:top-[10%] top-[50%] bs-mx:right-0 border-bright-sun-400 border  xs-mx:!left-5  rounded-lg p-2 backdrop-blur-md'>
            ...
            <div className='absolute xs-mx:-left-5 w-fit top-[28%] border-bright-sun-400 border bs-mx:top-[35%] xs-mx:top-[60%] xs-mx:!right-0  rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col'>
